...
export const SAX_COLORWAYS: SaxColorway[] = [
  ...
  },
  {
    id: "unlacquered",
    name: "Unlacquered",
    description: "Bare brass with no lacquer coat -- a warmer, matte read that darkens with handling.",
    body: 0xc8a877,
    bodyHighlight: 0xe9d5a8,
    keywork: 0xbec4c9,
    keyworkLight: 0xf0f3f4,
    keyworkDark: 0x545b61,
    pearl: 0xf0eadb,
  ...
  },
  {
    id: "vintage",
    name: "Vintage",
    description: "Aged gold lacquer with visible brass showing through at the high-wear edges.",
    body: 0x6b4a26,
    bodyHighlight: 0x9c7238,
    keywork: 0xc8922f,
    keyworkLight: 0xf1c65c,
    keyworkDark: 0x684611,
    pearl: 0xe6ddc4,
  ...
  },
  {
    id: "black-nickel",
    name: "Black nickel",
    description: "Matte black nickel body and keywork for a low-glare, low-contrast look.",
    body: 0x141416,
    bodyHighlight: 0x3a3c40,
    keywork: 0x2c2d30,
    keyworkLight: 0x54565a,
    keyworkDark: 0x1a1b1d,
    pearl: 0xd8d8d8,
    roughness: 0.3,
  },
];
...
export const SAX_SETUP_PARTS: SetupPart[] = [
  ...
  },
  {
    ...
    caveat: "Tip opening is a real measurement, but the tone labels come from the maker and may not match how the mouthpiece feels to you. Yamaha suggests a standard 4C with a 2½ reed as a starting point for beginners.",
    variants: [
      {
        id: "mouthpiece-4c",
        name: "4C · foundation",
  ...
  },
  {
    ...
    caveat: "The bars turn the makers’ descriptions into a simple side-by-side view. Treat them as a guide, not a measurement. The sound buttons play level-matched sketches, not recordings of the products.",
    variants: [
      {
        id: "reed-signature",
