...
const keys: FingeringChart["keys"] = [
  ...
  { id: "lh1", label: "L1", hand: "L", x: 50, y: 19 },
  { id: "lh2", label: "L2", hand: "L", x: 50, y: 28 },
  { id: "lh3", label: "L3", hand: "L", x: 50, y: 37 },
  ...
  { id: "rh1", label: "R1", hand: "R", x: 50, y: 49 },
  { id: "rh2", label: "R2", hand: "R", x: 50, y: 58 },
  { id: "rh3", label: "R3", hand: "R", x: 50, y: 67 },
