 ...
 *
 * Left-hand pinky keys: the source's "Fingering Scheme for Bassoon"
 * (basn_fing.html) places a real E♭ little-finger key next to the left
 * hand third finger key (used for E♭2, E♭3/G3-as-written-with-Eb, E4, F4,
 * F♯4, G4, G♯4) and a real low C♯ little-finger key just below it (used
 * for C♯2); both are pinky levers, not slivers between the finger holes.
 * The chart used to model these as a "trill sliver" between LH1/LH2 that
 * no fingering below actually presses -- fixed to the real pinky levers.
 */
...
const keys: FingeringChart["keys"] = [
  ...
  { id: "lhPinkyEb", label: "E♭ (L pinky)", hand: "L", x: 32, y: 38, shape: "lever", r: 3.6 },
  { id: "lhPinkyCs", label: "Low C♯ (L pinky)", hand: "L", x: 32, y: 46, shape: "lever", r: 3.6 },
  { id: "rhThumbBb", label: "Thumb B♭", hand: "thumb", x: 85, y: 38, shape: "lever", r: 4.2 },
  { id: "rhThumbE", label: "Thumb E vent", hand: "thumb", x: 85, y: 46, shape: "lever", r: 4.2 },
  { id: "rhThumbFsharp", label: "Thumb F♯", hand: "thumb", x: 85, y: 54, shape: "lever", r: 4.2 },
  { id: "rhThumbGsharp", label: "Thumb G♯", hand: "thumb", x: 85, y: 62, shape: "lever", r: 4.2 },
...
const fingerings: Fingering[] = [
  ...
  { id: "cs2", writtenMidi: 37, keys: ["thumbC", "thumbD", "lhPinkyCs", "lh1", "lh2", "lh3", "rhThumbE", "rh1", "rh2", "rh3", "rhPinkyF"], hint: "Left thumb holds both the C and D thumb keys; add the left-pinky low C♯ key." },
  ...
  { id: "eb2", writtenMidi: 39, keys: ["thumbD", "lhPinkyEb", "lh1", "lh2", "lh3", "rhThumbE", "rh1", "rh2", "rh3", "rhPinkyF"], hint: "Thumb stays on D; add the left-pinky E♭ key." },
  ...
  { id: "cs3", writtenMidi: 49, keys: ["whisper", "thumbCsharp", "thumbD", "lh1", "lh2", "lh3"], hint: "Whisper key, left thumb on both the C♯ and D thumb keys, same three left fingers." },
  ...
  { id: "g3", writtenMidi: 55, halfKeys: ["lh1"], keys: ["whisper", "lh2", "lh3", "lhPinkyEb", "rh1", "rh2", "rh3"], hint: "Half-hole the left index; left middle and ring down with the left-pinky E♭ key; all three right fingers." },
  ...
  { id: "cs4", writtenMidi: 61, keys: ["thumbCsharp", "thumbD", "lh1", "lh2", "lh3"], hint: "Left thumb on both the C♯ and D thumb keys; same three left fingers." },
  ...
  { id: "e4", writtenMidi: 64, keys: ["lh1", "lh3", "lhPinkyEb", "rh1", "rh2", "rh3"], hint: "Left index and ring (middle lifts) with the left-pinky E♭ key, plus all three right-hand fingers." },
  { id: "f4", writtenMidi: 65, keys: ["lh1", "lh3", "lhPinkyEb", "rh1", "rh2"], hint: "Same left hand as E4; right hand drops to index and middle only." },
  { id: "fs4", writtenMidi: 66, keys: ["lh2", "lh3", "lhPinkyEb", "rhThumbBb", "rh1", "rh2"], hint: "Left index lifts; left middle and ring stay down with the left-pinky E♭ key, right-thumb B♭ key, right index and middle." },
  { id: "g4", writtenMidi: 67, halfKeys: ["lh1"], keys: ["whisper", "lh2", "lh3", "lhPinkyEb", "rh1", "rhPinkyF"], hint: "Whisper key back on; half-hole the left index, left middle and ring with the left-pinky E♭ key, right index, right-pinky F key." },
  { id: "gs4", writtenMidi: 68, halfKeys: ["lh1"], keys: ["whisper", "lh2", "lh3", "lhPinkyEb", "rh3"], hint: "Half-hole the left index (covering closer to three-quarters), left middle and ring with the left-pinky E♭ key, right ring finger only." },
];
