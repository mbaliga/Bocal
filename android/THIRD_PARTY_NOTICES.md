# Third-party notices — Bocal Android 0.5

## saxophone alto

Model: `saxophone alto` by ANDRIANIAINAToky. License: Creative Commons Attribution 4.0 International (CC-BY-4.0).

Bundled license text:

`app/src/main/assets/www/licenses/saxophone-alto-CC-BY-4.0.txt`

## Oboe - Howarth Conservatoire S20C (Instrument)

Model: `Oboe - Howarth Conservatoire S20C (Instrument)` by WarderiiK. License: Creative Commons Attribution 4.0 International (CC-BY-4.0).
